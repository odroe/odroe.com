...
export function NavBar() {
  return (
    <header className="w-full z-10 top-0 dark:bg-gray-900 transition-all duration-300 ease-in-out sticky shadow-md shadow-gray-50 backdrop-blur-md bg-white/60">
